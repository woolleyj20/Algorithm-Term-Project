...
## Requirements
The only requirement to run the Jar file one the command line is to have Java 15.0.2 (most recent version) installed on your computer.
...
2. Open terminal and cd into the project folder then cd into the BibleStudyAlgorithm_jar folder (NOT the BibleStudyAlgorithm folder) 
<img width="635" alt="Screen Shot 2021-03-13 at 2 41 00 PM" src="https://user-images.githubusercontent.com/43599897/111051723-2463ed00-840a-11eb-8597-087550afcf98.png">
3. Once you are in the BibleStudyAlgorithm_jar folder, run the command: <b>java -jar BibleStudyAlgorithm.jar</b>
